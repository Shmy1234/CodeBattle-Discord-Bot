...
export async function handleWinner(interaction) {
    ...
    const isParticipant = winner.id === challenge.challengerId ||
    ...
    await interaction.reply(`${winner} won ${challenge.id} and earned 1 point.`);
}
